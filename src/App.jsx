...
import ZinnextDetailedView from './pages/common-detailedView';
import { colors } from './theme/colors/colors';
import { getStoredToken } from './services/dropdownApi';
import SubmissionsPage from './pages/Modules/SubmissionsPage';
import DashboardPage from './pages/Modules/DashboardPage';
import TestForm from './pages/TestingPage/test-form';
import TestingHomePage from './pages/TestingPage/testHomePage';
import LmsTestForm from './pages/TestingPage/lms-test-form';
import LmsHomePage from './pages/TestingPage/lmsHomePage';
import OnboardingHomePage from './pages/OnboardingHomePage';
import JobDetailView from './pages/SourceCandidatePage';
import JobDetailedView from './pages/JobDetailedView';
import SampleDetailedView from './pages/jobs-detailedView';
import CandidateDetailedView from './pages/candidate-detailedView';
import SubmissionDetailedView from './pages/submission-Detailedview';
import JobsDetailedView from './pages/jobs-detailedView';

import CandidateDetailView from './pages/Modules/Candidates/Candidatedetailview';
import CandidatePage from './pages/Modules/Candidates/CandidatePage';
import CandidateAddForm from './pages/Modules/Candidates/CandidateAddForm';
